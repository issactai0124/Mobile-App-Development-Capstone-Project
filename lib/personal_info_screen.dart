      ...
      if (countries.isNotEmpty) {
        setState(() {
          ...
          if (!_countries.contains(_country)) {
            // Keep existing country if valid, else first
            if (!_countries.contains(_country)) {
              // If current country is valid string but not in list, add it or reset?
              // Better to add it to be safe
              _countries = [_country, ..._countries];
            }
          }
        });
      }
